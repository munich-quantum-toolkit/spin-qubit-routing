...
try:
    version = metadata.version("mqt.sqr")
except ModuleNotFoundError:
    msg = "mqt.sqr must be installed to build the documentation"
...
modindex_common_prefix = ["mqt.sqr."]
...
html_theme_options = {
    ...
    "footer_icons": [
        ...
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/mqt-sqr/",
            "html": "",

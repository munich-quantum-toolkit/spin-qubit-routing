...
## Integrating MQT SQR into Your Project

To use the MQT SQR Python package in your project, add it as a dependency in
...
Set up a reproducible development environment for MQT SQR. This is the
